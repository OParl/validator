...
from ..schema import OPARL, SCHEMA_DIR, nameLong_not_equal_nameShort
...
class TestSchema(unittest.TestCase):
    ...
    def _do_test_json_validation(self, obj_type, testfile):
        ...
        self.assertIn(obj_type, OPARL.keys(), 'Invalid document type')
        self.assertIn(obj_type, OPARL, 'Missing schema')
        return OParlJson._validate_schema(OPARL[obj_type], data)
